<template>
      ...
      <div class="md:flex gap-4 justify-between w-full">
        <div class="md:w-[50%] pt-4">
          ...
          <div class="text-[#999999] text-sm">
            ヘルプセンター, Disputes & Reports, Buyer Protection,
            知的財産権の侵害を報告, Regulated Information
          </div>
        </div>
        <div class="md:w-[50%] pt-4">
          ...
          <div class="text-[#999999] text-sm">
            Pусский, Portuguese, Spanish, French, German, Italian, Dutch,
      ...
      <div class="md:flex gap-4 justify-between w-full">
        <div class="md:w-[50%] pt-4">
          ...
          <div class="text-[#999999] text-sm">
            ...
            China Brands, Blog, Seller Portal, BLACK FRIDAY, AliExpress
            Assistant
          </div>
        </div>
        <div class="md:w-[50%] pt-4">
  ...
  <div id="FooterSub" class="w-full bg-[#333333] text-sm text-gray-400">
    <div class="max-w-[1200px] mx-auto p-4">
      Intellectual Property Protection - Privacy Policy - サイトマップ - Terms
      of Use - Transaction Services Agreement for non-EU/UK Consumers - Terms
      and Conditions for EU/EEA/UK Consumers (Transactions) - User Information
      Legal Enquiry Guide ©️ 2010-2022 AliExpress.com. All rights reserved.
    </div>
  </div>
</template>
