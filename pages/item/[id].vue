  ...
  <MainLayout>
    <div id="ItemPage" class="mt-4 max-w-[1200px] mx-auto px-2">
      <div class="md:flex gap-4 justify-between mx-auto w-full">
        <div class="md:w-[40%]">
          <img :src="currentImage" class="rounded-lg object-fit" />
          <div
            v-if="currentImage"
        ...
        <div class="md:w-[60%] bg-white p-3 rounded-lg">
          ...
          <div class="flex items-center justify-start my-2">
            <Icon name="ic:baseline-star" color="#FF535353" />
            <Icon name="ic:baseline-star" color="#FF535353" />
            <Icon name="ic:baseline-star" color="#FF535353" />
            <Icon name="ic:baseline-star" color="#FF535353" />
            <Icon name="ic:baseline-star" color="#FF535353" />
            <span class="text-[12px] font-light ml-2"
              >5 213 Reviews 1,000+ Oders</span
            >
          </div>
          <div class="border-b" />
          ...
          <p class="text-[#009A66] text-xl font-semibold pt-1">
            Free 11-day Delivery over $8.99
          </p>
          <p class="text-[#009A66] text-xl font-semibold pt-1">Free Shipping</p>
          <div class="py-2" />
          <button
            @click="addToCart()"
            :disabled="isInCart"
...
onMounted(() => {
  watchEffect(() => {
    ...
    images[0] = "https://picsum.photos/id/77/800/800";
  });
});
